...
**Points 1 and 2 are just to alleviate the problem, but in fact, it does not solve the problem in the end, because the gateway is still hindsight**
...
1. Notify the deletion of the zk node and bring the node information to HTTP
